...
public final class ConstSQL {
    ...
    /** パスワード */
    public static final String JDBC_POSTGRES_PASS = "kami1021";

    // FIXME Step-2: 以下のSELECT文、INSESpring Tools 4 (aka Spring tool Suite 4) 4.6.0.RELEASERT文、UPDATE文を記述しなさい
