...
-- [回答]
 ...
 join goods_table on stock_table.store_code = store_table.store_code;
...
-- [回答]
 ...
 quantity > (SELECT AVG(quantity)FROM stock_table GROUP BY store_code HAVING store_code = 'EA01')
